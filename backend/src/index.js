...
// The original app.listen() and socket.io setup are commented out
// as Genezio functions are serverless and do not maintain long-running servers.
// If socket.io functionality is critical, it will require a separate deployment strategy
// or a different serverless provider that explicitly supports WebSockets.
...
// // Structure: { total: number, bySocket: { [socketId]: number }, byIp: { [ip]: number } }
...
//     console.error('Then kill it: Stop-Process -Id <PID> -Force  OR: taskkill /PID <PID> /F')
//     process.exit(1)
//   }
